...
struct  MEDIAPLAYER_ERROR_t2861322446 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MEDIAPLAYER_ERROR_t2861322446, ___value___1)); }
