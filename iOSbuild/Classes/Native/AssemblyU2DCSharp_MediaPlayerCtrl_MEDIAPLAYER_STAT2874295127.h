...
struct  MEDIAPLAYER_STATE_t2874295127 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MEDIAPLAYER_STATE_t2874295127, ___value___1)); }
