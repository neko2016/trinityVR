...
struct  GraphicsDeviceType_t1050523666 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GraphicsDeviceType_t1050523666, ___value___1)); }
